        ...
        <div className="space-top text-center overflow-hidden shape-mockup-wrap">
            <div className="container">
                <div className="title-area text-center">
                    ...
                    <span className="sub-title"><img src="/assets/img/icon/section-subtitle-icon.svg" alt="img" />{" "}{tr("Why Choose Us")}</span>
                        ...
                        <div className="wcu-card-wrap left-align">
                            <div className="wcu-card">
                                ...
                                <div className="wcu-card-details">
                                    ...
                                    <p className="wcu-card-text">{tr("We are expert your all work is very nice waiting for next project.")}</p>
                                </div>
                            </div>
                            <div className="wcu-card">
                                <div className="wcu-card-icon">
                                ...
                                <div className="wcu-card-details">
                                    ...
                                    <p className="wcu-card-text">{tr("All the Lorem Ipsum generators on the Internet tend to repeat predefined")}</p>
                                </div>
                            </div>
                            <div className="wcu-card">
                                <div className="wcu-card-icon">
                                ...
                                <div className="wcu-card-details">
                                    ...
                                    <p className="wcu-card-text">{tr("Making this the first true generator on the Internet uses a dictionary")}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="wcu-card-wrap right-align">
                            <div className="wcu-card">
                                ...
                                <div className="wcu-card-details">
                                    ...
                                    <p className="wcu-card-text">{tr("Passage of Lorem Ipsum, you need to be sure there isn't anything")}</p>
                                </div>
                            </div>
                            <div className="wcu-card">
                                <div className="wcu-card-icon">
